...
@WebInitParam(name = "location", value = "/tmp/upload") })
public class MultipartFilter implements Filter {
    ...
    public void init(FilterConfig config) throws ServletException {
        ...
        File uploadLocation = new File(this.location);
        if(!uploadLocation.exists())
        {
            System.out.println("ERROR: Upload save location does not exist!");
            System.out.println("Please create directory: " + this.location );
        }
